...
@interface BookLayoutConfig : NSObject <NSCopying>
...
@property (nonatomic, assign) int firstLineHeadIndent;      ///< 首行缩进  default:0.0f
...
- (BOOL)isEqualToLayoutConfig:(BookLayoutConfig*)aConfig;  ///< 精确匹配相等判断
- (BOOL)isMainParamEqualToLayoutConfig:(BookLayoutConfig*)aConfig; ///< 模糊匹配相等判断
