...
- (void)KIF_recordUnexpectedFailureForTestRun:(XCTestSuiteRun *)arg1 description:(id)arg2 exception:(NSException *)arg3
{
    if (![[arg3 name] isEqualToString:@"KIFFailureException"]) {
		...
		//NSUInteger value = [arg3.userInfo[@"SenTestLineNumberKey"] unsignedIntegerValue];
        //[arg1 recordFailureWithDescription:description inFile:arg3.userInfo[@"SenTestFilenameKey"] atLine:value expected:NO];
    }
}
