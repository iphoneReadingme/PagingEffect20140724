...
#import "iUIWebViewController2.h"
...
@implementation iUIWebViewController2

//@synthesize myWebView;

+ (NSString *)displayName {
	return @"Webkit 简单测试页面";
}
...
- (void)initObjects
{
	...
	[[[iUIWebViewManager sharedInstance] getCurrentWebPage] startNewRequest:pURL];
...
- (void)webViewDidStartLoad:(UIWebView *)webView
{
	...
	[[[iUIWebViewManager sharedInstance] getCurrentWebPage] webViewDidStartLoad:webView];
}

//数据加载完 
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
	[m_pWebView webViewDidFinishLoad:webView];
	//m_pWebView = [[iUIWebViewManager sharedInstance] getCurrentWebPage];
	//[[[iUIWebViewManager sharedInstance] getCurrentWebPage] webViewDidFinishLoad:webView];
}

- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
	//[[[iUIWebViewManager sharedInstance] getCurrentWebPage] webView:webView didFailLoadWithError:error];
	[m_pWebView didFailLoadWithError:error];
}
