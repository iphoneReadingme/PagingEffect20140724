...
///< 私有方法
@interface DemoPageView (/*DemoViewCoreTextDraw_private*/)
{
...
- (id)initWithFrame:(CGRect)frame
{
	...
	if (self) {
		...
		self.layoutConfig = [BookLayoutConfig bookLayoutConfigWithFontSize:18 andWidth:320 andHeight:440];
